    ...
    <div className="w-full max-w-lg mx-auto space-y-4 sm:space-y-5 px-2 sm:px-0">
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          {/* Vintage LCD Segment Slider per Neurale */}
            ...
            >
              ...
              <div className="absolute inset-2 flex items-center">
                {Array.from({ length: 20 }, (_, i) => {
                  ...
                  const isActive = state.neuralVolume >= segmentValue;
                  return (
                    <div 
                      key={i}
              ...
              <div 
                ...
                style={{
                  left: `calc(${state.neuralVolume * 100}% - 8px)`,
                  background: `
      ...
      {/* Volume Ambientali - Secondo Slider */}
      <div 
        className="p-3 sm:p-5 rounded-2xl border-2 border-graphite-edge device-texture"
        style={{ 
          background: 'var(--gradient-panel)',
      ...
      >
        <div className="flex flex-col items-center space-y-4">
          ...
          {/* Vintage LCD Segment Slider per Ambientali */}
          <div className="w-full max-w-xs relative">
            ...
            >
              ...
              {/* Segmenti LED progressivi - colore verde */}
              <div className="absolute inset-2 flex items-center">
                {Array.from({ length: 20 }, (_, i) => {
                  const segmentValue = (i + 1) / 20;
